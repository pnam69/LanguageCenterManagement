...
namespace LanguageCenterManagement.Migrations
{
    ...
    [Migration("20260923161203_questionsandsuch")]
    partial class questionsandsuch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.ListeningContent", b =>
                {
                    b.Property<int>("ListeningContentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ListeningContentId"));
                    ...
                    b.HasKey("ListeningContentId");

                    b.ToTable("ListeningContent");
                });
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.Question", b =>
                {
                    ...
                    b.HasIndex("ListeningContentId");

                    b.ToTable("Questions");
                });

            modelBuilder.Entity("LanguageCenterManagement.Models.ReadingContent", b =>
                {
                    b.Property<int>("ReadingContentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReadingContentId"));
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.SpeakingContent", b =>
                {
                    b.Property<int>("SpeakingContentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SpeakingContentId"));
                    ...
                    b.HasKey("SpeakingContentId");

                    b.HasIndex("QuestionId")
                        .IsUnique();

                    b.ToTable("SpeakingContent");
                });
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.WritingContent", b =>
                {
                    b.Property<int>("WritingContentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WritingContentId"));

                    b.Property<int>("MaximumWords")
                        .HasColumnType("int");
                    ...
                    b.HasKey("WritingContentId");

                    b.HasIndex("QuestionId")
                        .IsUnique();

                    b.ToTable("WritingContent");
                });
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.Question", b =>
                {
                    b.HasOne("LanguageCenterManagement.Models.ListeningContent", "ListeningContent")
                        .WithMany("Questions")
                        .HasForeignKey("ListeningContentId");

                    b.Navigation("ListeningContent");
                });

            modelBuilder.Entity("LanguageCenterManagement.Models.ReadingContent", b =>
                {
                    b.HasOne("LanguageCenterManagement.Models.Question", "Question")
                        .WithOne("ReadingContent")
                        .HasForeignKey("LanguageCenterManagement.Models.ReadingContent", "QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.SpeakingContent", b =>
                {
                    b.HasOne("LanguageCenterManagement.Models.Question", "Question")
                        .WithOne("SpeakingContent")
                        .HasForeignKey("LanguageCenterManagement.Models.SpeakingContent", "QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.WritingContent", b =>
                {
                    b.HasOne("LanguageCenterManagement.Models.Question", "Question")
                        .WithOne("WritingContent")
                        .HasForeignKey("LanguageCenterManagement.Models.WritingContent", "QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LanguageCenterManagement.Models.Question", b =>
                {
                    ...
                    b.Navigation("ReadingContent");

                    b.Navigation("SpeakingContent");

                    b.Navigation("WritingContent");
                });
